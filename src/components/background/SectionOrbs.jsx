...
export default function SectionOrbs({ config = [] }) {
  return (
    <div
      className="absolute inset-y-0 left-1/2 -ml-[50vw] w-screen z-0 pointer-events-none"
      aria-hidden="true"
    >
      {config.map((o, i) => (
        <div
        ...
        >
          <div
            style={{
              ...
              filter: 'blur(55px)',
              // multiplied by the global intensity variable so you can dim them all at once
